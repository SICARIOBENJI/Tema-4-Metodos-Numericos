 ...
 */
public class ModeloTablaTrapecio extends AbstractTableModel {

    private ArrayList<Trapecio> lista = new ArrayList<Trapecio>();
    private String[] columnas = {"i", "h", "a+ih", "f(a+ih)"};

    public ModeloTablaTrapecio(ArrayList<Trapecio> lista) {
        this.lista = lista;
    }

    public ModeloTablaTrapecio() {
    }
